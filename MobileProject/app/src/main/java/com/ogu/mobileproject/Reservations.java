...
public class Reservations extends AppCompatActivity implements CustomAdapter.OnCardListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lblReservation.setText("Rezervasyon İptal İşlemini Onaylıyor Musunuz?");
        btnYes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DB2.cancelRequest(CardId,User);
                Toast.makeText(Reservations.this, "Rezervasyon İptal İşleminiz Gerçekleştirildi!", Toast.LENGTH_SHORT).show();
