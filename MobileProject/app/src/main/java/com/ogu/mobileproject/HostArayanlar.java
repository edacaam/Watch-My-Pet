...
public class HostArayanlar extends AppCompatActivity implements CustomAdapter.OnCardListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_host_arayanlar);
        ...
        customAdapter = new CustomAdapter(HostArayanlar.this,startDate,endDate,price,address,animal,name,email,
                id,rozet1,rozet2,rozet3,rozet4,rozet5,rozet6,rozet7,rozet8,rozet9,rozet10,active,resUserID,this);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(HostArayanlar.this));
        dialog=new Dialog(HostArayanlar.this);
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(HostArayanlar.this, "Pet Sahibi İle Rezervasyonunuz Oluşturuldu!", Toast.LENGTH_SHORT).show();
    ...
    void storeDataInArrays(){
        Cursor cursor=DB2.FilterHostArayanlarData(User);
